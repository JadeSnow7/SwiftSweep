...
enum L10n {
  ...
  enum Status {
    ...
    static let peripherals = "status.peripherals"
    static let displays = "status.displays"
    static let inputDevices = "status.inputDevices"
    static let appleDiagnostics = "status.appleDiagnostics"
    static let diagnosticsGuide = "status.diagnosticsGuide"
    static let openSupport = "status.openSupport"
    static let unknownDisplay = "status.unknownDisplay"
    static let unknownDevice = "status.unknownDevice"
    static let noDisplayInfo = "status.noDisplayInfo"
    static let noInputInfo = "status.noInputInfo"
    static let builtIn = "status.builtIn"
    static let external = "status.external"
    static let mainDisplay = "status.mainDisplay"
    static let na = "status.na"
    static let deviceKindKeyboard = "status.deviceKind.keyboard"
    static let deviceKindMouse = "status.deviceKind.mouse"
    static let deviceKindTrackpad = "status.deviceKind.trackpad"
    static let deviceKindOther = "status.deviceKind.other"
    static let architecture = "status.architecture"
    static let architectureAppleSilicon = "status.architecture.appleSilicon"
    static let architectureIntel = "status.architecture.intel"
    static let architectureUnknown = "status.architecture.unknown"
