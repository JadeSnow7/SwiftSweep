...
struct TreemapLayout: View {
    ...
    private func calculateWorstAspect(indices: [Int], nodes: [FileNode], rowSize: Int64, totalSize: Int64, remaining: CGRect, isHorizontal: Bool) -> CGFloat {
...
#Preview {
    ...
    docs.addChild(FileNode(name: "file1.pdf", path: "/Users/test/Documents/file1.pdf", isDirectory: false, size: 5_000_000))
    docs.addChild(FileNode(name: "file2.docx", path: "/Users/test/Documents/file2.docx", isDirectory: false, size: 3_000_000))
    root.addChild(docs)
    root.addChild(FileNode(name: "movie.mp4", path: "/Users/test/movie.mp4", isDirectory: false, size: 10_000_000))
