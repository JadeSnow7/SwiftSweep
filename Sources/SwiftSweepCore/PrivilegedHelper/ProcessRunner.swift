...
public struct ProcessRunnerConfig: Sendable {
  ...
  public init(
    allowedExecutables: Set<String>, requireCodesign: Bool, maxOutputSize: Int,
...
public final class ProcessRunner: @unchecked Sendable {
  ...
  public func run(executable: String, arguments: [String], environment: [String: String] = [:])
    async -> CommandResult
  {
    ...
    return await withCheckedContinuation { continuation in
      runProcess(executable: canonicalPath, arguments: arguments, environment: environment) {
        result in
